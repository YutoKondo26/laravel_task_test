                    ...
                    <div class="container px-5 py-24 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="radio" id="gender" name="gender" class="" value="0" {{old('gender') == '1' ? 'checked' :''}} >男性
                                <input type="radio" id="gender" name="gender" class="" value="1" {{old('gender') == '2' ? 'checked' :''}}>女性
                            </div>
                            </div>
                            ...
                            <div class="p-2 w-full">
                            <div class="relative">
                                <input type="checkbox" id="caution" name="caution" class="" value="0">注意事項に同意する
                            </div>
                            </div>
